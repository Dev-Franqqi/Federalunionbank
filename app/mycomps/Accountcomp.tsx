...
export default function Accountcomp(){
    return(
        <section className="flex flex-wrap gap-y-4 justify-between gap-x-2 md:gap-1">

            <div className="w-[47%] md:w-1/5 flex flex-col justify-between py-8 px-6  bg-white rounded-xl h-[9rem]">
